...
def banner():
    ...
    print(" __  __  ____ ___  _  _         ____  __  __ ____ ")
    print("|  \/  |/ ___|__ \| || |       / ___||  \/  |  _ \\")
    print("| |\/| | |  _  / /| || |_     | |  _ | |\/| | |_) |")
    print("| |  | | |_| |/ /_|__   _|    | |_| || |  | |  _ < ")
    print("|_|  |_|\____|____|  |_|       \____||_|  |_|_| \_\\")
    
    print(Fore.YELLOW + Style.BRIGHT + "="*72)
    print(Fore.MAGENTA + Style.BRIGHT + "                    FLAGOUT - The Spinner CLI")
    print(Fore.CYAN + "                Created by: MG24 GAMER")
    print(Fore.GREEN + "       Join For More : Telegram : @MG24_GAMER_PRO")
    print(Fore.YELLOW + Style.BRIGHT + "="*72 + "\n")
